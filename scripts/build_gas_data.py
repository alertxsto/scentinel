...
MOLECULAR_FORMULAS: dict[str, tuple[dict[str, int], int]] = {
    ...
    "TRICHLOROETHANE_111": ({"C": 2, "H": 3, "Cl": 3}, 0),
    "TETRACHLOROETHANE_1122": ({"C": 2, "H": 2, "Cl": 4}, 0),
    "DICHLOROETHANE_11": ({"C": 2, "H": 4, "Cl": 2}, 0),
    "DICHLOROETHENE_11": ({"C": 2, "H": 2, "Cl": 2}, 0),
    "DICHLOROETHANE_12": ({"C": 2, "H": 4, "Cl": 2}, 0),
    "DICHLOROPROPANE_12": ({"C": 3, "H": 6, "Cl": 2}, 0),
    "PROPANOL_2": ({"C": 3, "H": 8, "O": 1}, 0),
    "ACETONE": ({"C": 3, "H": 6, "O": 1}, 0),
    "ACRYLONITRILE": ({"C": 3, "H": 3, "N": 1}, 0),
    "BROMODICHLOROMETHANE": ({"C": 1, "H": 1, "Br": 1, "Cl": 2}, 0),
    "BUTANE": ({"C": 4, "H": 10}, 0),
    "CARBON_DISULFIDE": ({"C": 1, "S": 2}, 0),
    "CARBON_TETRACHLORIDE": ({"C": 1, "Cl": 4}, 0),
    "CARBONYL_SULFIDE": ({"C": 1, "O": 1, "S": 1}, 0),
    "CHLOROBENZENE": ({"C": 6, "H": 5, "Cl": 1}, 1),
    "CHLORODIFLUOROMETHANE": ({"C": 1, "H": 1, "Cl": 1, "F": 2}, 0),
    "CHLOROETHANE": ({"C": 2, "H": 5, "Cl": 1}, 0),
    "CHLOROFORM": ({"C": 1, "H": 1, "Cl": 3}, 0),
    "CHLOROMETHANE": ({"C": 1, "H": 3, "Cl": 1}, 0),
    "DICHLOROBENZENE": ({"C": 6, "H": 4, "Cl": 2}, 1),
    "DICHLORODIFLUOROMETHANE": ({"C": 1, "Cl": 2, "F": 2}, 0),
    "DICHLOROFLUOROMETHANE": ({"C": 1, "H": 1, "Cl": 2, "F": 1}, 0),
    "DICHLOROMETHANE": ({"C": 1, "H": 2, "Cl": 2}, 0),
    "ETHANOL": ({"C": 2, "H": 6, "O": 1}, 0),
    "ETHYL_MERCAPTAN": ({"C": 2, "H": 6, "S": 1}, 0),
    "ETHYLBENZENE": ({"C": 8, "H": 10}, 1),
    "ETHYLENE_DIBROMIDE": ({"C": 2, "H": 4, "Br": 2}, 0),
    "FLUOROTRICHLOROMETHANE": ({"C": 1, "Cl": 3, "F": 1}, 0),
    "HEXANE": ({"C": 6, "H": 14}, 0),
    "METHYL_ETHYL_KETONE": ({"C": 4, "H": 8, "O": 1}, 0),
    "METHYL_ISOBUTYL_KETONE": ({"C": 6, "H": 12, "O": 1}, 0),
    "PENTANE": ({"C": 5, "H": 12}, 0),
    "PERCHLOROETHYLENE": ({"C": 2, "Cl": 4}, 0),
    "PROPANE": ({"C": 3, "H": 8}, 0),
    "T_DICHLOROETHENE_12": ({"C": 2, "H": 2, "Cl": 2}, 0),
    "TRICHLOROETHYLENE": ({"C": 2, "H": 1, "Cl": 3}, 0),
    "XYLENES": ({"C": 8, "H": 10}, 1),
}
...
GAS_IDENTITY = {
    ...
    "TRICHLOROETHANE_111": ("1,1,1-Trichloroethane (methyl chloroform)", 133.41),
    "TETRACHLOROETHANE_1122": ("1,1,2,2-Tetrachloroethane", 167.85),
    "DICHLOROETHANE_11": ("1,1-Dichloroethane (ethylidene dichloride)", 98.97),
    "DICHLOROETHENE_11": ("1,1-Dichloroethene (vinylidene chloride)", 96.94),
    "DICHLOROETHANE_12": ("1,2-Dichloroethane (ethylene dichloride)", 98.96),
    "DICHLOROPROPANE_12": ("1,2-Dichloropropane (propylene dichloride)", 112.99),
    "PROPANOL_2": ("2-Propanol (isopropyl alcohol)", 60.11),
    "ACETONE": ("Acetone", 58.08),
    "ACRYLONITRILE": ("Acrylonitrile", 53.06),
    "BROMODICHLOROMETHANE": ("Bromodichloromethane", 163.83),
    "BUTANE": ("Butane", 58.12),
    "CARBON_DISULFIDE": ("Carbon disulfide", 76.13),
    "CARBON_TETRACHLORIDE": ("Carbon tetrachloride", 153.84),
    "CARBONYL_SULFIDE": ("Carbonyl sulfide", 60.07),
    "CHLOROBENZENE": ("Chlorobenzene", 112.56),
    "CHLORODIFLUOROMETHANE": ("Chlorodifluoromethane", 86.47),
    "CHLOROETHANE": ("Chloroethane (ethyl chloride)", 64.52),
    "CHLOROFORM": ("Chloroform", 119.39),
    "CHLOROMETHANE": ("Chloromethane", 50.49),
    "DICHLOROBENZENE": ("Dichlorobenzene", 147.0),
    "DICHLORODIFLUOROMETHANE": ("Dichlorodifluoromethane", 120.91),
    "DICHLOROFLUOROMETHANE": ("Dichlorofluoromethane", 102.92),
    "DICHLOROMETHANE": ("Dichloromethane (methylene chloride)", 84.94),
    "ETHANOL": ("Ethanol", 46.08),
    "ETHYL_MERCAPTAN": ("Ethyl mercaptan (ethanethiol)", 62.13),
    "ETHYLBENZENE": ("Ethylbenzene", 106.16),
    "ETHYLENE_DIBROMIDE": ("Ethylene dibromide", 187.88),
    "FLUOROTRICHLOROMETHANE": ("Fluorotrichloromethane", 137.38),
    "HEXANE": ("Hexane", 86.18),
    "METHYL_ETHYL_KETONE": ("Methyl ethyl ketone", 72.11),
    "METHYL_ISOBUTYL_KETONE": ("Methyl isobutyl ketone", 100.16),
    "PENTANE": ("Pentane", 72.15),
    "PERCHLOROETHYLENE": ("Perchloroethylene (tetrachloroethylene)", 165.83),
    "PROPANE": ("Propane", 44.09),
    "T_DICHLOROETHENE_12": ("t-1,2-dichloroethene", 96.94),
    "TRICHLOROETHYLENE": ("Trichloroethylene (trichloroethene)", 131.4),
    "XYLENES": ("Xylenes", 106.16),
}
...
AP42_SOURCE_ROWS: dict[str, dict[str, str]] = {
    ...
    "TRICHLOROETHANE_111": {"table": "Table 2.4-1", "name": "1,1,1-Trichloroethane (methyl chloroform)"},
    "TETRACHLOROETHANE_1122": {"table": "Table 2.4-1", "name": "1,1,2,2-Tetrachloroethane"},
    "DICHLOROETHANE_11": {"table": "Table 2.4-1", "name": "1,1-Dichloroethane (ethylidene dichloride)"},
    "DICHLOROETHENE_11": {"table": "Table 2.4-1", "name": "1,1-Dichloroethene (vinylidene chloride)"},
    "DICHLOROETHANE_12": {"table": "Table 2.4-1", "name": "1,2-Dichloroethane (ethylene dichloride)"},
    "DICHLOROPROPANE_12": {"table": "Table 2.4-1", "name": "1,2-Dichloropropane (propylene dichloride)"},
    "PROPANOL_2": {"table": "Table 2.4-1", "name": "2-Propanol (isopropyl alcohol)"},
    "ACETONE": {"table": "Table 2.4-1", "name": "Acetone"},
    "ACRYLONITRILE": {"table": "Table 2.4-1", "name": "Acrylonitrile"},
    "BROMODICHLOROMETHANE": {"table": "Table 2.4-1", "name": "Bromodichloromethane"},
    "BUTANE": {"table": "Table 2.4-1", "name": "Butane"},
    "CARBON_DISULFIDE": {"table": "Table 2.4-1", "name": "Carbon disulfide"},
    "CARBON_TETRACHLORIDE": {"table": "Table 2.4-1", "name": "Carbon tetrachloride"},
    "CARBONYL_SULFIDE": {"table": "Table 2.4-1", "name": "Carbonyl sulfide"},
    "CHLOROBENZENE": {"table": "Table 2.4-1", "name": "Chlorobenzene"},
    "CHLORODIFLUOROMETHANE": {"table": "Table 2.4-1", "name": "Chlorodifluoromethane"},
    "CHLOROETHANE": {"table": "Table 2.4-1", "name": "Chloroethane (ethyl chloride)"},
    "CHLOROFORM": {"table": "Table 2.4-1", "name": "Chloroform"},
    "CHLOROMETHANE": {"table": "Table 2.4-1", "name": "Chloromethane"},
    "DICHLOROBENZENE": {"table": "Table 2.4-1", "name": "Dichlorobenzene"},
    "DICHLORODIFLUOROMETHANE": {"table": "Table 2.4-1", "name": "Dichlorodifluoromethane"},
    "DICHLOROFLUOROMETHANE": {"table": "Table 2.4-1", "name": "Dichlorofluoromethane"},
    "DICHLOROMETHANE": {"table": "Table 2.4-1", "name": "Dichloromethane (methylene chloride)"},
    "ETHANOL": {"table": "Table 2.4-1", "name": "Ethanol"},
    "ETHYL_MERCAPTAN": {"table": "Table 2.4-1", "name": "Ethyl mercaptan (ethanethiol)"},
    "ETHYLBENZENE": {"table": "Table 2.4-1", "name": "Ethylbenzene"},
    "ETHYLENE_DIBROMIDE": {"table": "Table 2.4-1", "name": "Ethylene dibromide"},
    "FLUOROTRICHLOROMETHANE": {"table": "Table 2.4-1", "name": "Fluorotrichloromethane"},
    "HEXANE": {"table": "Table 2.4-1", "name": "Hexane"},
    "METHYL_ETHYL_KETONE": {"table": "Table 2.4-1", "name": "Methyl ethyl ketone"},
    "METHYL_ISOBUTYL_KETONE": {"table": "Table 2.4-1", "name": "Methyl isobutyl ketone"},
    "PENTANE": {"table": "Table 2.4-1", "name": "Pentane"},
    "PERCHLOROETHYLENE": {"table": "Table 2.4-1", "name": "Perchloroethylene (tetrachloroethylene)"},
    "PROPANE": {"table": "Table 2.4-1", "name": "Propane"},
    "T_DICHLOROETHENE_12": {"table": "Table 2.4-1", "name": "t-1,2-dichloroethene"},
    "TRICHLOROETHYLENE": {"table": "Table 2.4-1", "name": "Trichloroethylene (trichloroethene)"},
    "XYLENES": {"table": "Table 2.4-1", "name": "Xylenes"},
}
